...
<!DOCTYPE html>
<!--[if IE 7]> <html lang="<?php echo $lang; ?>" class="ie7 <?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo ($page_direction[$language_id] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo ($page_direction[$language_id] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <![endif]-->  
<!--[if IE 8]> <html lang="<?php echo $lang; ?>" class="ie8 <?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo ($page_direction[$language_id] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo ($page_direction[$language_id] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <![endif]-->  
<!--[if IE 9]> <html lang="<?php echo $lang; ?>" class="ie9 <?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo ($page_direction[$language_id] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo ($page_direction[$language_id] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <![endif]-->  
<!--[if !IE]><!--> <html lang="<?php echo $lang; ?>" class="<?php if($theme_options->get( 'responsive_design' ) == '0') { echo 'no-'; } ?>responsive<?php echo ($page_direction[$language_id] == 'RTL' ? ' rtl' : '' ) ?>" <?php echo ($page_direction[$language_id] == 'RTL' ? 'dir="rtl"' : '' ) ?>> <!--<![endif]-->  
<head>
<?php echo $adk_cookie_script; ?>
    ...
    <?php if($theme_options->get( 'quick_search_autosuggest' ) != '0' && $_GET['route'] != 'account/tracking' && $klasa != 'account-tracking') { ?>
...
<div class="twitter_<?php if($theme_options->get( 'widget_twitter_position' ) == 1) { echo 'left'; } else { echo 'right'; } ?> hidden-xs hidden-sm">
	...
	<div class="twitter-content">
		<a class="twitter-timeline" href="https://twitter.com/<?php echo $theme_options->get( 'widget_twitter_user_name' ); ?>" data-tweet-limit="<?php echo $theme_options->get( 'widget_twitter_limit' ); ?>">Tweets by <?php echo $theme_options->get( 'widget_twitter_user_name' ); ?></a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
	</div>

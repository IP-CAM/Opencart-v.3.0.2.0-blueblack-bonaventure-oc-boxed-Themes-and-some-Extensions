	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['date_added'] = date($this->language->get('date_format_short'), strtotime($order_info['date_added']));
				...
				$data['time_added'] = date($this->language->get('time_format'), strtotime($order_info['date_added']));
				$data['time_modified'] = date($this->language->get('time_format'), strtotime($order_info['date_modified']));
       ...
       'image'    => $image,
			...
			$order_status_info = $this->model_localisation_order_status->getOrderStatus($order_info['order_status_id']);
					...
					if (($order_info['phonecus']=$order_info['emailcus']) > 1) {
						$data['moreorder'] = 1;
					} else {
						$data['moreorder'] = 0;
					}
			...
			foreach ($custom_fields as $custom_field) {
				if ($custom_field['custom_field_id'] != 1 &&
					...
					$custom_field['custom_field_id'] != 11
				) {
					continue;
				}
				...
				if ($custom_field['location'] == 'account' && isset($order_info['custom_field'][$custom_field['custom_field_id']])) {
					...
					if ($custom_field_value_info) {
						if ($custom_field['custom_field_id'] == 8) {
							$data['custom_invoice_type'] = $custom_field_value_info['name'];
						}

						if ($custom_field['custom_field_id'] == 9) {
							$data['custom_how_did_find'] = $custom_field_value_info['name'];
						}
					}
				}
				...
				if ($custom_field['location'] == 'address' && isset($order_info['payment_custom_field'][$custom_field['custom_field_id']])) {
					...
					if ($custom_field_value_info) {
						if ($custom_field['custom_field_id'] == 4) {
							$data['custom_vat'] = $custom_field_value_info['name'];
						}
					}

					if ($custom_field['custom_field_id'] == 1) {
						$data['custom_fiscal_code'] = array(
							'name'  => $custom_field['name'],
							'value' => $order_info['payment_custom_field'][$custom_field['custom_field_id']],
						);
					}
				...
				if ($custom_field['location'] == 'address' && isset($order_info['shipping_custom_field'][$custom_field['custom_field_id']])) {
					...
					if ($custom_field_value_info) {
						if ($custom_field['custom_field_id'] == 4) {
							$data['shipping_custom_vat'] = $custom_field_value_info['name'];
						}
					}
					
					if ($custom_field['custom_field_id'] == 1) {
						$data['shipping_custom_fiscal_code'] = array(
							'name'  => $custom_field['name'],
							'value' => $order_info['shipping_custom_field'][$custom_field['custom_field_id']],
						);
					}
					...
					if ($custom_field['custom_field_id'] == 2) {
						$data['shipping_custom_reg_comert'] = array(
							'name'  => $custom_field['name'],
							'value' => $order_info['shipping_custom_field'][$custom_field['custom_field_id']],
						);
					}
					if ($custom_field['custom_field_id'] == 11) {
						$data['shipping_custom_phone'] = array(
							'name'  => $custom_field['name'],
							'value' => $order_info['shipping_custom_field'][$custom_field['custom_field_id']],
						);
					}
			...
			if (isset($data['payment_address'])) {
				if (isset($data['custom_vat'])) {
					$data['payment_address'] .= '<br>' . $data['custom_vat'];
				}

				if (isset($data['custom_fiscal_code'])) {
					$data['payment_address'] .= '<br>' . $data['custom_fiscal_code']['name'] . ' ' . $data['custom_fiscal_code']['value'];
				}

				if (isset($data['custom_reg_comert'])) {
					$data['payment_address'] .= '<br>' . $data['custom_reg_comert']['name'] . ' ' . $data['custom_reg_comert']['value'];
				}
			}

			if (isset($data['shipping_address'])) {
				if (isset($data['shipping_custom_vat'])) {
					$data['shipping_address'] .= '<br>' . $data['shipping_custom_vat'];
				}

				if (isset($data['custom_fiscal_code'])) {
					$data['shipping_address'] .= '<br>' . $data['shipping_custom_fiscal_code']['name'] . ' ' . $data['shipping_custom_fiscal_code']['value'];
				}

				if (isset($data['shipping_custom_reg_comert'])) {
					$data['shipping_address'] .= '<br>' . $data['shipping_custom_reg_comert']['name'] . ' ' . $data['shipping_custom_reg_comert']['value'];
				}
				if (isset($data['shipping_custom_phone'])) {
					$data['shipping_address'] .= '<br>' . $data['shipping_custom_phone']['name'] . ' ' . $data['shipping_custom_phone']['value'];
				}
			}

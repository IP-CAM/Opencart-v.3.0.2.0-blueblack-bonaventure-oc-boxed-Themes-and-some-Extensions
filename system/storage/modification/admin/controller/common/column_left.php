...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/module/sainent_extensions')) {
				$data['menus'][] = array(
					'id'       => 'menu-sainent-extensions',
					'icon'	   => 'fa-puzzle-piece', 
					'name'	   => $this->language->get('text_sainent_extensions'),
...
if ($this->user->hasPermission('access', 'extension/module/bulk_special')) {
        $marketplace[] = array(
          'name'     => 'Bulk Special',
          ...
          'children' => array()   
			...
			if ($this->user->hasPermission('access', 'extension/jsub_category')) {
				$this->load->language('extension/jsub_category_link');
				$marketplace[] = array(
					'name'	   => $this->language->get('text_jsub_category'),
			...
			if ((float)$other_total && $order_total) {
				...
				if ( class_exists( 'Advertikon\Adk_Gdpr\Advertikon' ) ) {
					Advertikon\Adk_Gdpr\Advertikon::instance()->add_to_left_panel( $data );
				}
